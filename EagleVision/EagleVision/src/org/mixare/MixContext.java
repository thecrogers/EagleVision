...
public class MixContext extends ContextWrapper implements MixContextInterface {
	...
	public void doResume(Context mixView) {
	...
	public Context getActualMixView() {
		synchronized (mixView) {
			return this.mixView;
		}
	}

	private void setActualMixView(Context mixView2) {
		synchronized (mixView) {
			this.mixView = mixView2;
		}
	}
