...
public class Compatibility {
	...
	static public int getRotation(final MixView mixView) {
		int result = 1;
		/*try {
				Display display = ((WindowManager) ( (Activity) mixView).getSystemService(Context.WINDOW_SERVICE)).getDefaultDisplay();
